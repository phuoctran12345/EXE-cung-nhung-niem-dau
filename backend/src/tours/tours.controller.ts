...
export class ToursController {
  ...
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles('admin')
  async createDestination(@Body() body: { name: string; slug?: string; toursCount?: string; img?: string; stayPricePerNight?: number }) {
  ...
  async updateDestination(
    @Param('id') id: string,
    @Body() body: { name?: string; slug?: string; toursCount?: string; img?: string; stayPricePerNight?: number },
  ) {
